$(document).ready(function() { 
	...
	jQuery('.userinfo').click(function(){
		if(!jQuery(this).hasClass('userinfodrop')) {
			var t = jQuery(this);
			jQuery('.userdrop').width(t.width() + 30);	//make this width the same with the account info wrapper
	...
	jQuery(document).click(function(event) {
		...
		//hide account drop menu when clicked outside of this element
    ...
    $(window).resize(function(){
     ...
     $(".dropdown img.flag").addClass("flagvisibility");
        ...
        //Duy?t h?t c�c ph?n t? divTabs, th�m class active cho tag a d?u ti�n
        ...
        $(".divTab .atab").click(function () {
            ...
            var activeTab = $(this).attr("title"); //Active n?i dung tab n�o c� class = title c?a a
